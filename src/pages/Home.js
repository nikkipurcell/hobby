...
const Home = () => {
  return (
    <React.Fragment>
      <Header />
      <main>
        <h1>hobby <span className='pronunciation'>[hob-ee]</span></h1>
        <h3 className='pronoun'>noun, plural hob·bies.</h3>

        <Link to="/category/past" className='btn-primary'>Past Hobbies</Link>
        ...
        <div>
          ...
          <Link to="/category/ideas" className='btn-primary'>Hobby Ideas</Link>
        </div>
      </main>
    </React.Fragment>
  );
